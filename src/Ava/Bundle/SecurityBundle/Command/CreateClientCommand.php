...
namespace Ava\Bundle\SecurityBundle\Command;
...
class CreateClientCommand extends ContainerAwareCommand
{
	...
	{
		$this
			->setName('ava:security:oauth:client:create')
...
EOT
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$output->writeln(
			sprintf('Added a new client with name <info>%s</info> and public id <info>%s</info>, secret <info>%s</info>.',
				$client->getName(),
				$client->getPublicId(),
				$client->getSecret()
			)
